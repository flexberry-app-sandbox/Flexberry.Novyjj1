...
namespace IIS.Novyjj1
{
    ...
    [AutoAltered()]
    [Caption("Справочники контрагенты")]
    ...
    public class СпрКонтраг : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СпрКонтрагE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрКонтрагE", typeof(IIS.Novyjj1.СпрКонтраг));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СпрКонтрагL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрКонтрагL", typeof(IIS.Novyjj1.СпрКонтраг));
                }
            }
        }
    }
